...
defineProps({
    trashed_comic_publishers: Object,
});
</script>
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tbody>
                                            <tr
                                                ...
                                                v-if="
                                                    trashed_comic_publishers.length >
                                                    0
                                                "
                                                v-for="trashed_comic_publisher in trashed_comic_publishers"
                                                :key="
                                                    trashed_comic_publisher.id
                                                "
                                            >
                                                <td
                                                ...
                                                >
                                                    ...
                                                    <Link
                                                        :href="
                                                            route(
                                                                'comics.publishers.destroy_permanent',
                                                                trashed_comic_publisher.id
                                                            )
                                                        "
                                                    >
