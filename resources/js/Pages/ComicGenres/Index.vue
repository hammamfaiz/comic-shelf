...
const onSearch = (search) => {
    location.href = `/comics/genres?search=${search}`;
};
        ...
        <div class="py-10">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="w-full flex">
                    <div class="w-1/2">
                        <Link :href="route('comics.genres.create')">
                            <PrimaryButton class="bg-amber-300">
                                Add New Comic Genre
                            </PrimaryButton>
                        </Link>
                        <Link :href="route('comics.genres.trashed')">
                    ...
                    <div class="w-1/2">
                        <TextInput
                            ...
                            type="text"
                            class="block w-full"
                            placeholder="Search Comic Genres..."
                            v-model="search"
